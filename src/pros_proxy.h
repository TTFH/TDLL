...
PROXY(amateurs, prosdk_mods_mod_list_result_release);
PROXY(amateurs, prosdk_mods_mod_item_release);
PROXY(amateurs, prosdk_mods_mod_complaint_type_array_release);
PROXY(amateurs, prosdk_mods_connect);
PROXY(amateurs, prosdk_mods_disconnect);
PROXY(amateurs, prosdk_mods_get_connection_state);
PROXY(amateurs, prosdk_mods_get_mod);
PROXY(amateurs, prosdk_mods_get_mods_by_search_filter);
PROXY(amateurs, prosdk_mods_get_complaint_type_array);
PROXY(amateurs, prosdk_mods_subscribe_to_mod);
PROXY(amateurs, prosdk_mods_unsubscribe_from_mod);
PROXY(amateurs, prosdk_mods_submit_mod_complaint);
...
PROXY(amateurs, hydra5_diagnostics_crash_dump_upload_token);
PROXY(amateurs, hydra5_diagnostics_get_crash_reporter_token);
PROXY(amateurs, hydra5_diagnostics_release_crash_reporter_token);
